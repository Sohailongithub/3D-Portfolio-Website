  ...
  return (
    <>
     ...
     <motion.p
      ...
      >
        I'm a Skilled Software Developer with experience in HTML 5, CSS 3 and JavaScript, And expertise in frameworks like 
        React, Vite, Node.js, Next.js, Three.js, Framer Motion. I'm a quick learner and collaborate closely with clients to create efficient,
